...
class FelszereltsegAction extends MainAction
{
    public function runWithParams($params)
    {
        ...
        $query           = Felszereltseg::find()->orderBy(['name' => SORT_ASC]);
    ...
    public function save($formData)
    {
        ...
        $result      = [];
        $model       = empty($formData["id"]) ? new Felszereltseg() : Felszereltseg::findOne($formData["id"]);
